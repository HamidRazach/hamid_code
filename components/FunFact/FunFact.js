...
const FunFact = [
    {
        ...
        symbol: '+',
        icon: "/images/icon/c_01.svg",
    },
    {
        title: '30',
        subTitle: 'Visa Process',
        symbol: 'K+',
        icon: "/images/icon/c_02.svg",
        style:'style-2',
    },
    {
        title: '40',
                            ...
                            {FunFact.map((funfact, fitem) => (
                                <div className={`xb-item--item ul_li ${funfact.style}`} key={fitem}>
                                    <div className="xb-item--icon">
                                        <Image src={funfact.icon} alt="featured-image" width={300} height={400}/>
                                    </div>
