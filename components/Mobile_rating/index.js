        ...
        <div className="row">
          ...
          <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-6">
            <div className={styles.rating_box}>
              <div className={styles.rating_svg}>
                <Image
                  src="/images/rating_logo/app_dev_dubai.webp"
                  alt="Apps Launched"
                  loading="lazy"
                  width={61}
                  height={61}
          ...
          <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-6">
            <div className={styles.rating_box}>
              <div className={styles.rating_svg}>
                <Image
                  src="/images/rating_logo/live_apps_dubai.webp"
                  alt="App Development Experts"
                  loading="lazy"
                  width={61}
                  height={61}
                />
          ...
          <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-6">
            <div className={styles.rating_box}>
              <div className={styles.rating_svg}>
                <Image
                  src="/images/rating_logo/development_years.webp"
                  alt="Active App Users"
                  loading="lazy"
                  width={61}
                  height={61}
                />
