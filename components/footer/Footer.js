                    ...
                    <div className="diract_contact_links text-white">
                        <div className="iconbox_block layout_icon_left">
                            <div className="iconbox_icon">
                                <Image src="/images/icons/icon_mail.svg" width={20} height={20} alt="Mail SVG Icon" />
                            </div>
                        ...
                        <div className="iconbox_block layout_icon_left">
                            <div className="iconbox_icon">
                                <Image src="/images/icons/icon_calling.svg" width={20} height={20} alt="Calling Check SVG Icon" />
                            </div>
                            <div className="iconbox_content">
                        ...
                        <div className="iconbox_block layout_icon_left">
                            <div className="iconbox_icon">
                                <Image src="/images/icons/icon_map_mark.svg" width={20} height={20} alt="Map Mark Check SVG Icon" />
                            </div>
                            <div className="iconbox_content">
                                ...
                                <div className="footer_widget pe-md-3">
                                    ...
                                    <form className="footer_newslatter" onSubmit={SubmitHandler}>
                                        <label htmlFor="footer_mail_input">
                                            <Image src="/images/icons/icon_mail_2.svg" width={20} height={20} alt="Mail SVG Icon" />
                                        </label>
