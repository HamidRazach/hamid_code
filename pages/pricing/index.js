...
import PartnerSection from '../../components/about_page/PartnerSection';
...
const PricingPage = (props) => {
    ...
    return (
        <Fragment>
        <Head>
        <title>Pricing Plans | Digital Minds On</title>
        <meta 
          name="description" 
          content="Explore flexible pricing plans at Digital Minds On. Get affordable, high-quality app, web, and game development services tailored to your business needs." 
        />
        <link 
          rel="canonical" 
          href="https://digitalmindson.com/pricing" 
        />
      </Head>
                            ...
                            <div className="col-lg-6">
                                <div className={`pricing_block ${isActive ? 'active' : ''}`}>
                                    <div className="best_plan">
                                        <Image src="/images/icons/best_offer.svg" alt="Best Offer" width={54} height={72}/>
                                    </div>
                                    <div className="table_head">
                                        <div className="pricing_price_value bg-primary-subtle text-primary">
                                            <span className="pricing_monthly">
